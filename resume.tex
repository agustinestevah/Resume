...
\section{Awards \& Achievements}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Dean's List:}{ Awarded for academic excellence at the University of Chicago} \\ \vspace{3pt}

        \textbf{University Advanced Scholar:}{ Half-ride scholarship for selective accelerated coursework track} \\ \vspace{3pt}
    
        \textbf{Hispanic Scholarship Fund Scholar:}{ Recognized for academic achievement and leadership potential} \\ \vspace{3pt}
